  ...
  Future<void> fetchData() async {
    try {
      DocumentSnapshot doc = await FirebaseFirestore.instance
          ...
          .doc('gKyxgvZrZPp6K3Dd4QNY')
          .get();

      if (doc.exists) {
        setState(() {
          fetchedPassword = doc.get('password');
          fetchedSSID = doc.get('ssid');
        });
      } else {
              ...
              if (connectionname != ' ') Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          if (allHotspots.isNotEmpty) Expanded(
                                            ...
                                            InkWell(
                                              onTap: () {
                                                ...
                                                void connectToWiFi() async {
                                                  if (fetchedSSID != null && fetchedPassword != null) {
                                                    bool success = await WiFiForIoTPlugin.connect(
                                                      fetchedSSID!,
                                                      password: fetchedPassword!,
                                                      security: NetworkSecurity.WPA,  // WPA or WEP depending on your Wi-Fi
                                                    );
                                                    ...
                                                    if (success) {
                                                      print('Successfully connected to $fetchedSSID');
                                                    } else {
                                                      print('Failed to connect to $fetchedSSID');
                                                    }
                                                  }
                                                }
                                                connectToWiFi();

                                                print(fetchedPassword.toString());
                                                print(fetchedSSID.toString());
